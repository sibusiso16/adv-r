...
Coercion often happens automatically. Most mathematical functions (`+`, `log`, `abs`, etc.) will coerce to numeric. This is particularly useful for logical vectors because `TRUE` becomes 1 and `FALSE` becomes 0.
...
There is one final difference: `tibble()` allow you to refer to newly created variables:
